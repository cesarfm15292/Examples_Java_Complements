...
public class MarcoEmergente2 {
	...
	public static void main(String[] args) {
		...
		MarcoEmergenteWithCboxRButton mimarco=new MarcoEmergenteWithCboxRButton();
...
class MarcoEmergenteWithCboxRButton extends JFrame{
	
	public MarcoEmergenteWithCboxRButton() {
		
		setBounds(500, 400, 550, 350);
		setVisible(true);
		
		CboxRbuttonMenuLaminaEmerg milamina=new CboxRbuttonMenuLaminaEmerg();
		add(milamina);
	}
}

class CboxRbuttonMenuLaminaEmerg extends JPanel{
	...
	public CboxRbuttonMenuLaminaEmerg() {
...
//-------------------------------------------------------------------- TRAIDO DE LA CLASE MARACO EMERGENTE -----------------------		
		JPopupMenu mEmergente=new JPopupMenu();		
		...
		mEmergente.add(negritaE);
		mEmergente.add(cursivaE);
//---------------------------------------------------------------------------------------------		
