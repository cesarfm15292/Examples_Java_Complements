...
public class MarcoEmergente3 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		MEmergenteCboxRButton mimarco=new MEmergenteCboxRButton();
...
class MEmergenteCboxRButton extends JFrame{
	
	public MEmergenteCboxRButton() {
		
		setBounds(500, 400, 550, 350);
		setVisible(true);
		
		CboxRbMenuLamEmerg milamina=new CboxRbMenuLamEmerg();
		add(milamina);
	}
}

class CboxRbMenuLamEmerg extends JPanel{
